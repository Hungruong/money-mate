...
public class AuthController {
    ...
    @Autowired private JwtUtils jwtUtils; // Use the Spring-managed instance
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest request) {
        try {
            ...
            String token = jwtUtils.generateJwtToken(authentication); // Use the injected JwtUtils instance
